...
export const CATEGORIES: CategoryInfo[] = [
  {
    id: 'baby-walkers',
    name: 'Baby Walkers',
    shortDesc: 'Multi-height activity walkers with music, rattle toys & anti-tip stability bumper.',
    iconName: 'Footprints',
    badge: 'Safe & Padded',
  ...
  {
    id: 'riders',
    name: 'Riders & Push Cars',
    shortDesc: 'Ergonomic push along cars with steering horn & backrest support for toddlers.',
    iconName: 'Car',
    badge: 'Push & Glide',
  ...
  },
  {
    ...
    shortDesc: 'Ergonomic, easy-clean potty trainers in cute animal & ride-on scooter shapes.',
    iconName: 'Sparkles',
    badge: 'Hygienic & Fun',
  ...
  {
    id: 'electric-rideons',
    name: 'Electric Rideons',
    shortDesc: 'Battery operated tractors, excavators & quad bikes with remote control.',
    iconName: 'Car',
    badge: 'Battery Powered',
    bgGradient: 'from-[#FFEDD5]/35 via-[#FED7AA]/30 to-[#FFEDD5]/10',
    accentColor: '#F97316',
    textColor: 'text-[#C2410C]',
    itemCount: 5,
    bannerImage: 'https://images.unsplash.com/photo-1558060370-d644479be6f7?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 'rocking-animals',
    name: 'Rocking Animals',
    shortDesc: '2-in-1 smooth rocking rockers that convert to ride-on rolling wheels.',
    iconName: 'Smile',
    badge: 'Dual Rock & Roll',
    bgGradient: 'from-[#F472B6]/25 via-[#FBCFE8]/30 to-[#F472B6]/10',
    accentColor: '#EC4899',
    textColor: 'text-[#BE185D]',
    itemCount: 4,
    bannerImage: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?auto=format&fit=crop&q=80&w=800'
  },
  {
    id: 'tri-cycles',
    name: 'Kids Tri Cycles',
    shortDesc: 'Sturdy 3-wheel tricycles with parent push handles & rear storage baskets.',
    iconName: 'Car',
    badge: 'Pedal & Push',
  ...
  },
  {
    id: 'kick-scooters',
    name: 'Kick Scooters',
    shortDesc: '3-wheel height adjustable lean-to-steer scooters with flashing LED wheels.',
    iconName: 'Sparkles',
    badge: 'Flashing LED',
